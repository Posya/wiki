...
The infrastructure admins run an LDAP server and a https://jenkins-ci.org/account[small frontend program] to let users create accounts on `jenkins-ci.org`. This account is used for all the software that we run ourselves.
